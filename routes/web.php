...
Route::get('rentadas',            		'PropertyController@rentadas')->name('rentadas');
Route::get('rentadas.show',            	'PropertyController@rentadas_show')->name('rentadas.show');
Route::get('vendidas',            		'PropertyController@vendidas')->name('vendidas');
Route::get('vendidas.show',            	'PropertyController@vendidas_show')->name('vendidas.show');
...
Route::get('/editar_propiedad/{id}',    'PropertyController@editar_propiedad');
