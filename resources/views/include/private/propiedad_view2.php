    ...
    <div class="contenedor bg-light" id="contenedor">
        ...
        <div class="container">
            <div class="row">
				...
				if (!empty($_GET ['id'])) {$id = utf8_decode($_GET['id']);} else {$id = '1';}
				...
				{		
					...
					if ($in_ab_ba == 1) {$in_ab_ba = "BanRural";} 			else
					if ($in_ab_ba == 2) {$in_ab_ba = "Banco Inductrial";} 	else
					if ($in_ab_ba == 3) {$in_ab_ba = "Banco Reformador";}	else
					if ($in_ab_ba == 4) {$in_ab_ba = "Banco CHN";}			else
					if ($in_ab_ba == 5) {$in_ab_ba = "Banco Promerica";}	else
					if ($in_ab_ba == 6) {$in_ab_ba = "Banco de Guatemala";} else
					if ($in_ab_ba == 7) {$in_ab_ba = "Banco G&T";}			else 
					if ($in_ab_ba == 8) {$in_ab_ba = "Otro";} 
					...
					if ($data_user > 0) 
					{
						...
						if ($owner_ec == 1) {$owner_ec = "Casado(a)";} 	else
						if ($owner_ec == 2) {$owner_ec = "Soltero(a)";} else
						if ($owner_ec == 3) {$owner_ec = "Unido(a)";} 	else
						if ($owner_ec == 4) {$owner_ec = "Viudo(a)";} 	else
						if ($owner_ec == 5) {$owner_ec = "Divorciado(a)";} else 
						{$owner_ec = "-";}

						if ($owner_pr == 1)  {$owner_pr = "Sr";} 		else
						if ($owner_pr == 2)  {$owner_pr = "Sra";} 		else
						if ($owner_pr == 3)  {$owner_pr = "Srita";} 	else
						if ($owner_pr == 4)  {$owner_pr = "Ing";} 		else
						if ($owner_pr == 5)  {$owner_pr = "Dr";} 		else 
						if ($owner_pr == 6)  {$owner_pr = "Dra";} 		else 
						if ($owner_pr == 7)  {$owner_pr = "Lic";} 		else 
						if ($owner_pr == 8)  {$owner_pr = "Licda";} 	else 
						if ($owner_pr == 9)  {$owner_pr = "Baco";} 		else 
						if ($owner_pr == 10) {$owner_pr = "Conta";} 	else 
						if ($owner_pr == 11) {$owner_pr = "Prof";} 		else 
						if ($owner_pr == 12) {$owner_pr = "Profa";} 	else 
						{$owner_pr = "-";}
					}
                ...
                <div class="col-12 col-lg-8 p-1">
                            ...
                            <div class="col">
                                <ul class="images-properties">
									...
									if ( is_dir("../assets/images/propiedades/".$in_mu_id."/") ) 
									{
										...
										{
											?>
                                    <li data-thumb="../assets/images/propiedades/<?php echo $in_mu_id.'/'.$i.'.jpg'; ?>"
                                        data-src="../assets/images/propiedades/<?php echo $in_mu_id.'/'.$i.'.jpg'; ?>">
                                        <img src="../assets/images/propiedades/<?php echo $in_mu_id.'/'.$i.'.jpg'; ?>"
                                            class="w-100" />
                                    </li>
                                    <?php
										}
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <p class="text-left">
                                            <?php if($in_ad_em > 0){echo $in_ad_em;}else{echo "-";}; ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12">
                                ...
                                <iframe width="100%" height="100%"
                                    src="https://www.youtube.com/embed/<?php echo $link_youtube; ?>?controls=0"
                                    frameborder="0"
                    ...
                    <!-- Precio -->
                    <div
                        class="container rounded border shadow-sm info-property mt-4 pt-4 pl-5 pr-5 pb-4 bg-primary text-white">
                        <div class="row mt-3">
                            <div class="col-11">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <span
                                            class="badge bg-light text-danger p-2 rounded-0 align-bottom info-property-title">VENTA</span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <span
                                            class="badge bg-light text-danger p-2 rounded-0 align-bottom info-property-title">RENTA</span>
                    ...
                    <div class="col-12 p-0 mt-3 ">
                        <form action="#" method="POST">
                            <?php
								...
								{
									?>
                            <a name="" class="btn btn-outline-primary"
                                href="propiedad_edit.php?id=<?php echo ($in_mu_id); ?>" role="button"><i
                                    class="fas fa-highlighter"></i> Actualizar Propiedad
                            </a>
                            <?php
								}
							?>
                            ...
                            <div class="col-12 text-center">
                                ...
                                <div class="col-6 p-0 mx-auto">
                                    <img class="img-thumbnail rounded-circle"
                                        src="../assets/images/usuarios/<?php echo ($aseso_id); ?>.png"
                                        alt="nombre_asesor">
                                </div>
                                ...
                                <p>
                                    <a name="" id="" class="btn fb-color text-white float-left"
                                        href="<?php echo ($us_sn_fb); ?>" role="button">
                                        <span class="">
                                            <i class="fab fa-facebook"></i>
                                        </span>
                                    </a>

                                    <a name="" id="" class="btn tw-color text-white " href="<?php echo ($us_sn_fb); ?>"
                                        role="button">
                                        <span class="">
                                    ...
                                    <a name="" id="" class="btn ins-color text-white float-right"
                                        href="<?php echo ($us_sn_fb); ?>" role="button">
                                        <span class="">
                                ...
                                <p>
                                    <a name="" id="" class="btn btn-success mb-lg-3 mb-xl-0"
                                        href="https://wa.me/50253689090?text=Estoy%20interesado%20en%20la%20propiedad%20COD:<?php echo ($in_mu_id); ?> "
                                        role="button">
                                        <span class="mr-2">
                                ...
                                <p class="mb-3">
                                    ...
                                    <button class="btn btn-info mb-lg-3 mb-xl-0"
                                        href="mailto:sarah.alzugaray@propiedadesplatinum.com">Email</button>
                                </p>
                                    ...
                                    <form action="#" method="POST">
                                        <?php
											...
											if ($usertipe == 1 or $usertipe == 2) 
											{
												?>
                                        <a name="" class="btn btn-outline-primary"
                                            href="usuario_edit.php?id=<?php echo $aseso_id;?>" role="button"><i
                                                class="fas fa-highlighter"></i> Actualizar Asesor
                                        </a>
                                        <?php
											}
										?>
                                    ...
                                    <form action="#" method="POST">
                                        <?php
											...
											if ($usertipe == 1 or $usertipe == 2) 
											{
												?>
                                        <a name="" class="btn btn-outline-primary"
                                            href="usuario_edit.php?id=<?php echo $owner_id;?>" role="button"><i
                                                class="fas fa-highlighter"></i> Actualizar Propietario
                                        </a>
                                        <?php
											}
										?>
