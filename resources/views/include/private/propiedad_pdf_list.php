...
<body style="margin: 0!important;">
					...
					?>
						...
						<form action="#" method="POST">
							<div class="card-footer clearfix">
								<a name="" class="btn rounded-5 btn-info float-right  text-decoration-none pt-2 pb-2" id="pdf_start" href="#" role="button"><i class="fas fa-plus"></i> Generar PDF
								</a>
							</div>
						</form>
	...
	<div id="afterpdf" style="width: 0; height: 0;"></div>

	<script>
		function pdfhide() {
			$('#pdfcontent').ready(function () {
				setTimeout(function(){ $('.creating-pdf').hide("swing"); }, 5500);
			});
		}
		$(document).ready(function() {
			initGeneral();
			$('#pdf_start').click(function (e) { 
				e.preventDefault();
				console.log('clickfunciona');
				$('.creating-pdf').show("swing");
				$('#afterpdf').after('<iframe id="pdfcontent" src="propiedad_pdf_view.php" onLoad="pdfhide()" marginwidth="0" marginheight="0" name="pdfcontainer" scrolling="no" border="0" frameborder="0" width="0" height="0"></iframe>');
			});
