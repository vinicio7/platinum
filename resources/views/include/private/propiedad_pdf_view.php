...
if ($count_prop > 0) {
	...
	$query_user = mysqli_query($con, "SELECT * FROM `si_users` WHERE `username`= '" . $username . "'");
...
<body>
	...
	<div class="pdf-container-page-1" id="page<?php echo $count_p; ?>">
		...
		<div class="titles-container">
			<div class="titles-content">
				...
				<!-- <div class="subtitle">
					<h3><strong>COD. <?php echo ($in_mu_id); ?></strong></h3>
				</div> -->
			</div>
			...
			<div class="content-details">
				...
				<div class="details">
					...
					<!-- <?php //if ($in_in_ct == 1 || $in_in_bm == 1 || $in_in_al == 1 || $in_in_eb == 1 || $in_in_cs == 1 || $in_in_aa == 1) { 
							?> -->
					<?php if ($in_in_re == 1 || $in_in_lm == 1 || $in_in_aa == 1 || $in_in_et == 1 || $in_in_cs == 1 || $in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) { ?>
						<h3>INCLUYE</h3>
						...
						<p>
							...
							if ($in_in_re == 1) {
								echo ("Refrigeradora");
								if ($in_in_lm == 1 || $in_in_aa == 1 || $in_in_et == 1 || $in_in_cs == 1 || $in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Lampara
							if ($in_in_lm == 1) {
								echo ("Lampara");
								if ($in_in_aa == 1 || $in_in_et == 1 || $in_in_cs == 1 || $in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Aire Acoindicionado
							if ($in_in_aa == 1) {
								echo ("Aire Acoindicionado");
								if ($in_in_et == 1 || $in_in_cs == 1 || $in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Estufa de Gas
							if ($in_in_et == 1) {
								echo ("Estufa de Gas");
								if ($in_in_cs == 1 || $in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Cortinas
							if ($in_in_cs == 1) {
								echo ("Cortinas");
								if ($in_in_al == 1 || $in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Alarmas
							if ($in_in_al == 1) {
								echo ("Alarmas");
								if ($in_in_ee == 1 || $in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Estufa Eléctrica
							if ($in_in_ee == 1) {
								echo ("Estufa Eléctrica");
								if ($in_in_bl == 1 || $in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Blackouts
							if ($in_in_bl == 1) {
								echo ("Blackouts");
								if ($in_in_cm == 1 || $in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Cámaras de Seguridad
							if ($in_in_cm == 1) {
								echo ("Cámaras de Seguridad");
								if ($in_in_lv == 1 || $in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Lavavajillas
							if ($in_in_lv == 1) {
								echo ("Lavavajillas");
								if ($in_in_cb == 1 || $in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Cortinas de baño
							if ($in_in_cb == 1) {
								echo ("Cortinas de baño");
								if ($in_in_ps == 1 || $in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Páneles Solares
							if ($in_in_ps == 1) {
								echo ("Páneles Solares");
								if ($in_in_ca == 1 || $in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Campanas
							if ($in_in_ca == 1) {
								echo ("Campanas");
								if ($in_in_ct == 1 || $in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Calentador de Agua
							if ($in_in_ct == 1) {
								...
								if ($in_in_bm == 1 || $in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Bomba y Cisterna
							if ($in_in_bm == 1) {
								...
								if ($in_in_ld == 1 || $in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Lavadora
							if ($in_in_ld == 1) {
								echo ("Lavadora");
								if ($in_in_eb == 1 || $in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Espejos de Baño
							if ($in_in_eb == 1) {
								...
								if ($in_in_db == 1 || $in_in_sd == 1) {
									echo (", ");
								}
							}
							// Depósito de Basura
							if ($in_in_db == 1) {
								echo ("Depósito de Basura");
								if ($in_in_sd == 1) {
									echo (", ");
								}
							}
						...
						?>
						<?php if ($in_am_gi == 1 || $in_am_ca == 1 || $in_am_as == 1 || $in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) { ?>
							<h3>AMENIDADES</h3>
							<p>
								<?php
								// ------------------------------------------------------------------------------------------------------
								...
								if ($in_am_rr == 1) {
									echo ("Razor Ribbon");
									if ($in_am_pt || $in_am_gi == 1 || $in_am_ca == 1 || $in_am_as == 1 || $in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Planta Telefónica
								if ($in_am_pt == 1) {
									echo ("Planta Telefónica");
									if ($in_am_gi == 1 || $in_am_ca == 1 || $in_am_as == 1 || $in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Gimnasio
								if ($in_am_gi == 1) {
									echo ("Gimnasio");
									if ($in_am_ca == 1 || $in_am_as == 1 || $in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Canchas Deportivas
								if ($in_am_ca == 1) {
									echo ("Canchas Deportivas");
									if ($in_am_as == 1 || $in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Área Social
								if ($in_am_as == 1) {
									echo ("Área Social");
									if ($in_am_sp == 1 || $in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Spá
								if ($in_am_sp == 1) {
									echo ("Spá");
									if ($in_am_sa == 1 || $in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Spá
								...
								if ($in_am_sa == 1) {
									echo ("Sauna");
									if ($in_am_sb == 1 || $in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Salón de Belleza
								if ($in_am_sb == 1) {
									echo ("Salón de Belleza");
									if ($in_am_pi == 1 || $in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Piscina
								if ($in_am_pi == 1) {
									echo ("Piscina");
									if ($in_am_bc == 1 || $in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Business Center
								if ($in_am_bc == 1) {
									echo ("Business Center");
									if ($in_am_gu == 1 || $in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Guardianía
								if ($in_am_gu == 1) {
									echo ("Guardianía");
									if ($in_am_ga == 1 || $in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Garita
								if ($in_am_ga == 1) {
									echo ("Garita");
									if ($in_am_ju == 1 || $in_am_pa == 1) {
										echo (", ");
									}
								}
								// Juegos Infantiles
								if ($in_am_ju == 1) {
									echo ("Juegos Infantiles");
									if ($in_am_pa == 1) {
										echo (", ");
									}
								}
		...
		<div class="footer">
			...
			<div class="info-contact-container">
				<div class="agent-info-content">
					...
					<h5><strong style="font-size: 22px;">Info/cel:</strong> +502 <?php echo ($aseso_te); ?></h5>
					<h6><?php if ($aseso_fn != "Sarah") { ?>
							<strong style="font-size: 22px;">Correo:</strong>
						<?php } 	?> <?php echo ($aseso_co); ?></h6>
				</div>
			</div>
		</div>
	...
	<?php
	for ($i = 1; $i <= ($count_prop - 1) and $i < 20; $i++) {
		$ferow = mysqli_fetch_array($query);
		...
		<div class="pdf-container-page-1" id="page<?php echo $count_p; ?>">
			...
			<div class="titles-container">
				<div class="titles-content">
					...
					<!-- <div class="subtitle">
						<h3><strong>COD. <?php //echo ($in_mu_id); 
												?></strong></h3>
					</div> -->
				</div>
				<div class="pleca-container">
...
<script>
	$(document).ready(function() {
		var conteo = <?php echo ($count_prop); ?>;
		// console.log(conteo);
		if (conteo > 0) {
			$(function() {
				var options = {};
				...
				// PROPIEDAD NO. 1
				pdf.addHTML($('#page1'), 0, 0, options, function() {
					pdf.addPage();
					pdf.addHTML($('#page2'), 0, 0, options, function() {
						// PROPIEDAD NO. 2
						if (conteo > 1) {
							pdf.addPage();
							pdf.addHTML($('#page3'), 0, 0, options, function() {
								pdf.addPage();
								pdf.addHTML($('#page4'), 0, 0, options, function() {
									// PROPIEDAD NO. 3
									if (conteo > 2) {
										pdf.addPage();
										pdf.addHTML($('#page5'), 0, 0, options, function() {
											pdf.addPage();
											pdf.addHTML($('#page6'), 0, 0, options, function() {
												// PROPIEDAD NO. 4
												if (conteo > 3) {
													pdf.addPage();
													pdf.addHTML($('#page7'), 0, 0, options, function() {
														pdf.addPage();
														pdf.addHTML($('#page8'), 0, 0, options, function() {
															// PROPIEDAD NO. 5
															if (conteo > 4) {
																pdf.addPage();
																pdf.addHTML($('#page9'), 0, 0, options, function() {
																	pdf.addPage();
																	pdf.addHTML($('#page10'), 0, 0, options, function() {
																		// PROPIEDAD NO. 6
																		if (conteo > 5) {
																			pdf.addPage();
																			pdf.addHTML($('#page11'), 0, 0, options, function() {
																				pdf.addPage();
																				pdf.addHTML($('#page12'), 0, 0, options, function() {
																					// PROPIEDAD NO. 7
																					if (conteo > 6) {
																						pdf.addPage();
																						pdf.addHTML($('#page13'), 0, 0, options, function() {
																							pdf.addPage();
																							pdf.addHTML($('#page14'), 0, 0, options, function() {
																								// PROPIEDAD NO. 8
																								if (conteo > 7) {
																									pdf.addPage();
																									pdf.addHTML($('#page15'), 0, 0, options, function() {
																										pdf.addPage();
																										pdf.addHTML($('#page16'), 0, 0, options, function() {
																											// PROPIEDAD NO. 9
																											if (conteo > 8) {
																												pdf.addPage();
																												pdf.addHTML($('#page17'), 0, 0, options, function() {
																													pdf.addPage();
																													pdf.addHTML($('#page18'), 0, 0, options, function() {
																														// PROPIEDAD NO. 10
																														if (conteo > 9) {
																															pdf.addPage();
																															pdf.addHTML($('#page19'), 0, 0, options, function() {
																																pdf.addPage();
																																pdf.addHTML($('#page20'), 0, 0, options, function() {
																																	// PROPIEDAD NO. 11
																																	if (conteo > 10) {
																																		pdf.addPage();
																																		pdf.addHTML($('#page21'), 0, 0, options, function() {
																																			pdf.addPage();
																																			pdf.addHTML($('#page22'), 0, 0, options, function() {
																																				// PROPIEDAD NO. 12
																																				if (conteo > 11) {
																																					pdf.addPage();
																																					pdf.addHTML($('#page23'), 0, 0, options, function() {
																																						pdf.addPage();
																																						pdf.addHTML($('#page24'), 0, 0, options, function() {
																																							// PROPIEDAD NO. 13
																																							if (conteo > 12) {
																																								pdf.addPage();
																																								pdf.addHTML($('#page25'), 0, 0, options, function() {
																																									pdf.addPage();
																																									pdf.addHTML($('#page26'), 0, 0, options, function() {
																																										// PROPIEDAD NO. 14
																																										if (conteo > 13) {
																																											pdf.addPage();
																																											pdf.addHTML($('#page27'), 0, 0, options, function() {
																																												pdf.addPage();
																																												pdf.addHTML($('#page28'), 0, 0, options, function() {
																																													// PROPIEDAD NO. 15
																																													if (conteo > 14) {
																																														pdf.addPage();
																																														pdf.addHTML($('#page29'), 0, 0, options, function() {
																																															pdf.addPage();
																																															pdf.addHTML($('#page30'), 0, 0, options, function() {
																																																// PROPIEDAD NO. 16
																																																if (conteo > 15) {
																																																	pdf.addPage();
																																																	pdf.addHTML($('#page31'), 0, 0, options, function() {
																																																		pdf.addPage();
																																																		pdf.addHTML($('#page32'), 0, 0, options, function() {
																																																			// PROPIEDAD NO. 17
																																																			if (conteo > 16) {
																																																				pdf.addPage();
																																																				pdf.addHTML($('#page33'), 0, 0, options, function() {
																																																					pdf.addPage();
																																																					pdf.addHTML($('#page34'), 0, 0, options, function() {
																																																						// PROPIEDAD NO. 18
																																																						if (conteo > 17) {
																																																							pdf.addPage();
																																																							pdf.addHTML($('#page35'), 0, 0, options, function() {
																																																								pdf.addPage();
																																																								pdf.addHTML($('#page36'), 0, 0, options, function() {
																																																									// PROPIEDAD NO. 19
																																																									if (conteo > 18) {
																																																										pdf.addPage();
																																																										pdf.addHTML($('#page37'), 0, 0, options, function() {
																																																											pdf.addPage();
																																																											pdf.addHTML($('#page38'), 0, 0, options, function() {
																																																												// PROPIEDAD NO. 20
																																																												if (conteo > 19) {
																																																													pdf.addPage();
																																																													pdf.addHTML($('#page39'), 0, 0, options, function() {
																																																														pdf.addPage();
																																																														pdf.addHTML($('#page40'), 0, 0, options, function() {
																																																															pdf.save('listado_propiedades.pdf');
																																																														});
																																																													});
																																																												} else {
																																																													pdf.save('listado_propiedades.pdf');
