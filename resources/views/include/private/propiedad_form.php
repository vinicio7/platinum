...
//CONTEO_PROPIEDADES		
$query = mysqli_query($con,	"SELECT `in_mu_id` FROM `si_properties` WHERE 1 ORDER BY `si_properties`.`in_mu_id` DESC");
...
if (
	isset($_POST['in_titul']) && !empty($_POST['in_titul']) &&
	isset($_POST['in_nombr']) && !empty($_POST['in_nombr'])
) {
	...
	else 
	{
		...
		//ALMACENA EN BASE DE DATOS SI ES VENTA
		if ($_POST['in_pre_v'] > 0) {
			$in_mu_id = $in_mu_id + 1;
			mysqli_query($con, "INSERT INTO `si_properties`(
			`in_mu_id`, `in_titul`, `in_porce`, `in_pre_r`, `in_pre_v`, `in_nombr`, `in_tip_p`, `in_vende`, `in_ab_a1`, `in_ab_a2`, `in_ab_at`, `in_ab_ba`, 
			`in_ab_de`, `in_ab_fi`, `in_ab_fo`, `in_ab_g1`, `in_ab_g2`, `in_ab_iu`, `in_ab_li`, `in_ab_ni`, `in_ab_re`, `in_ab_tc`, `in_ab_s1`, `in_ab_s2`, 
			`in_ac_co`, `in_ac_pi`, `in_ac_pu`, `in_ac_te`, `in_ac_ve`, `in_ad_co`, `in_ad_em`, `in_ad_ex`, `in_ad_po`, `in_ad_pu`, `in_am_am`, `in_am_as`, 
			`in_am_bc`, `in_am_ca`, `in_am_ga`, `in_am_gi`, `in_am_gu`, `in_am_ju`, `in_am_ot`, `in_am_pa`, `in_am_pi`, `in_am_pt`, `in_am_rr`, `in_am_sa`, 
			`in_am_sb`, `in_am_sp`, `in_am_sr`, `in_ar_ii`, `in_ar_it`, `in_co_an`, `in_co_ba`, `in_co_bs`, `in_co_d1`, `in_co_d2`, `in_co_j1`, `in_co_j2`, 
			`in_co_mt`, `in_co_ni`, `in_co_p1`, `in_co_p2`, `in_co_te`, `in_de_ac`, `in_de_b2`, `in_de_ba`, `in_de_bi`, `in_de_bj`, `in_de_bo`, `in_de_bv`, 
			`in_de_cb`, `in_de_cc`, `in_de_ch`, `in_de_cl`, `in_de_co`, `in_de_cr`, `in_de_de`, `in_de_ds`, `in_de_du`, `in_de_dv`, `in_de_es`, `in_de_j1`, 
			`in_de_j2`, `in_de_ja`, `in_de_je`, `in_de_la`, `in_de_oa`, `in_de_ot`, `in_de_pa`, `in_de_pe`, `in_de_po`, `in_de_s1`, `in_de_s2`, `in_de_s3`, 
			`in_de_sa`, `in_de_te`, `in_de_ti`, `in_de_wa`, `in_di_de`, `in_di_di`, `in_di_mu`, `in_di_pa`, `in_di_re`, `in_di_zo`, `in_e1_ce`, `in_e1_no`, 
			`in_e1_t1`, `in_e1_t2`, `in_e2_ce`, `in_e2_no`, `in_e2_t1`, `in_e2_t2`, `in_fi_cn`, `in_fi_cp`, `in_fi_en`, `in_fi_es`, `in_fi_pl`, `in_fi_sn`, 
			`in_fi_ta`, `in_in_aa`, `in_in_al`, `in_in_bl`, `in_in_bm`, `in_in_ca`, `in_in_cb`, `in_in_cm`, `in_in_cs`, `in_in_ct`, `in_in_db`, `in_in_eb`, 
			`in_in_ee`, `in_in_et`, `in_in_io`, `in_in_ld`, `in_in_lm`, `in_in_lv`, `in_in_ps`, `in_in_re`, `in_in_sd`, `in_ma_cu`, `in_ma_in`, `in_mante`, 
			`in_por_r`, `in_se_ag`, `in_se_ba`, `in_se_li`, `in_se_lu`, `in_se_se`, `in_ab_yo`, `in_estat`, `in_us_po`, `in_fe_in`
			)
			VALUES
			(
			'$in_mu_id', '$in_titul', '$in_porce', '0',         '$in_pre_v', '$in_nombr', '$in_tip_p', '$in_vende', '$in_ab_a1', '$in_ab_a2', '$in_ab_at', '$in_ab_ba', 
			'$in_ab_de', '$in_ab_fi', '$in_ab_fo', '$in_ab_g1', '$in_ab_g2', '$in_ab_iu', '$in_ab_li', '$in_ab_ni', '$in_ab_re', '$in_ab_tc', '$in_ab_s1', '$in_ab_s2', 
			'$in_ac_co', '$in_ac_pi', '$in_ac_pu', '$in_ac_te', '$in_ac_ve', '$in_ad_co', '$in_ad_em', '$in_ad_ex', '$in_ad_po', '$in_ad_pu', '$in_am_am', '$in_am_as', 
			'$in_am_bc', '$in_am_ca', '$in_am_ga', '$in_am_gi', '$in_am_gu', '$in_am_ju', '$in_am_ot', '$in_am_pa', '$in_am_pi', '$in_am_pt', '$in_am_rr', '$in_am_sa', 
			'$in_am_sb', '$in_am_sp', '$in_am_sr', '$in_ar_ii', '$in_ar_it', '$in_co_an', '$in_co_ba', '$in_co_bs', '$in_co_d1', '$in_co_d2', '$in_co_j1', '$in_co_j2', 
			...
			if (isset($_FILES["archivo"]))
			{
				$in_munum = 0;
				$reporte  = null;
				mkdir("../assets/images/propiedades/$in_mu_id", 0777);
		...
		} //FIN ALMACENA EN BASE DE DATOS SI ES VENTA



		//ALMACENA EN BASE DE DATOS SI ES RENTA
		if ($_POST['in_pre_r'] > 0) {
			$in_mu_id = $in_mu_id + 1;
			mysqli_query($con, "INSERT INTO `si_properties`(
			`in_mu_id`, `in_titul`, `in_porce`, `in_pre_r`, `in_pre_v`, `in_nombr`, `in_tip_p`, `in_vende`, `in_ab_a1`, `in_ab_a2`, `in_ab_at`, `in_ab_ba`, 
			...
			VALUES
			(
			'$in_mu_id', '$in_titul', '$in_porce', '$in_pre_r', '0',         '$in_nombr', '$in_tip_p', '$in_vende', '$in_ab_a1', '$in_ab_a2', '$in_ab_at', '$in_ab_ba', 
			'$in_ab_de', '$in_ab_fi', '$in_ab_fo', '$in_ab_g1', '$in_ab_g2', '$in_ab_iu', '$in_ab_li', '$in_ab_ni', '$in_ab_re', '$in_ab_tc', '$in_ab_s1', '$in_ab_s2', 
			'$in_ac_co', '$in_ac_pi', '$in_ac_pu', '$in_ac_te', '$in_ac_ve', '$in_ad_co', '$in_ad_em', '$in_ad_ex', '$in_ad_po', '$in_ad_pu', '$in_am_am', '$in_am_as', 
			'$in_am_bc', '$in_am_ca', '$in_am_ga', '$in_am_gi', '$in_am_gu', '$in_am_ju', '$in_am_ot', '$in_am_pa', '$in_am_pi', '$in_am_pt', '$in_am_rr', '$in_am_sa', 
			'$in_am_sb', '$in_am_sp', '$in_am_sr', '$in_ar_ii', '$in_ar_it', '$in_co_an', '$in_co_ba', '$in_co_bs', '$in_co_d1', '$in_co_d2', '$in_co_j1', '$in_co_j2', 
			...
			if ($_POST['in_pre_v'] > 0 and $_POST['in_pre_r'] > 0) {
				//COPIA DE CARPETA DE FOTOS
				$source = "../assets/images/propiedades/" . ($in_mu_id - 1) . "/";
				$target = "../assets/images/propiedades/" . ($in_mu_id)   . "/";
				if (is_dir($source)) {
					@mkdir($target);
					$d = dir($source);
		...
		} //FIN ALMACENA EN BASE DE DATOS SI ES RENTA
...
?>
		...
		<script type="text/javascript">
			window.location.replace("propiedad_list.php");
		</script>
		<?php
		?>
		...
		<div style="position: fixed;top: 115px; left: 50%; z-index: 1500;">
			<div id="toastregistrosGuardados" class="toast " role="alert" aria-live="assertive" aria-atomic="true">
				...
				<div class="toast-body bg-light text-success">
					Se almacenaron los datos de la propiedad: <?php echo $_POST['in_titul']; ?>
				</div>
			</div>
		</div>
		<script>
...
<body style="margin: 0!important;">
		...
		<div class="container-fluid p-1 p-md-4 p-xl-5">
			<section class="content p-3 p-md-4 p-xl-5 rounded shadow" id="contentBox">
				...
				<div class="container">
					...
					<!-- FORMULARIO INGRESO ************************ -->
					<form action="propiedad_form.php" id="formNuevasPropiedades" method="POST" role="form" class="f1 pt-0 pb-0 p-0" autocomplete="off" enctype="multipart/form-data" />

					<h3>Formulario de Propiedad</h3>
					<p>Propiedad - <?php echo "COD: " . ($in_mu_id + 1); ?></p>
					<div class="f1-steps">
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6 col-xl-6 order-xl-1 order-md-1 ">
								...
								<textarea type="text" class="form-control" name="in_titul" placeholder="Casa Espectacular en Las Alturas" rows="1"></textarea>
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-3 order-md-4 ">
								...
								<input list="propietario" class="form-control" name="in_nombr" placeholder="Propietario / Proyecto" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-4 order-md-2 " id="contenedor">
								...
								<input type="text" name="quetz1" class="quetz form-control" step="0.01" min="0" max="999999999" placeholder="Precio Venta (Q)" /> -->
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-4 order-md-2 " id="contenedor">
								<!-- <span class="fas fa-dollar-sign    form-control-feedback"></span>
								<input type="text" name="in_pre_v" class="dolar form-control" step="0.01" min="0" max="999999999" placeholder="Precio Venta ($)" /> -->
							...
							<!-- PRECIO_VENTA 
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-4 order-md-2 ">
								<span class="fas fa-dollar-sign form-control-feedback"></span>
								<input type="number" step="0.01" min="0" max="999999999" class="form-control" name="in_pre_v" placeholder="Precio de Venta" />
							</div> -->
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-8 order-md-2 " id="contenedor">
								...
								<!-- <span class="far fa-money-bill-alt form-control-feedback"></span>
								<input type="text" name="quetz2" class="quetz form-control" step="0.01" min="0" max="999999999" placeholder="Precio Renta (Q)" /> -->
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-8 order-md-2 " id="contenedor">
								<!-- <span class="fas fa-dollar-sign    form-control-feedback"></span>
								<input type="text" name="in_pre_r" class="dolar form-control" step="0.01" min="0" max="999999999" placeholder="Precio Renta ($)" /> -->
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-9 order-md-6">
								<span class="fa fa-percent form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_por_r" placeholder="Honorarios" />
								<label class="label-form-control" for="in_por_r">Honorarios (Renta):</label>
							</div>

							<!-- PRECIO_RENTA 
							<div class="form-group input-custom-icon col-sm-12 col-md-4 col-xl-3 order-xl-5 order-md-5 ">
								<span class="fas fa-dollar-sign form-control-feedback"></span>
								<input type="number" step="0.01" min="0" max="999999999" class="form-control" name="in_pre_r" placeholder="Precio de Renta" />
							</div> -->
						...
						<div class="row pb-3">
							...
							<div class="form-group col-sm-12 col-md-3">
								...
								<div class="form-group clearfix">
									...
									<div class="icheck-sunflower d-inline">
										<input type="radio" id="financiamiento2" name="in_fi_sn" value="0" checked />
							...
							<div class="form-group col-sm-12 col-md-3">
								...
								<div class="form-group clearfix">
									...
									<div class="icheck-sunflower d-inline">
										<input type="radio" id="canjePermuta2" name="in_fi_cp" value="0" checked />
								...
								<div class="row">
									...
									<div class="form-group col-sm-12 col-md-3">
										...
										<div class="form-group clearfix">
											...
											<div class="icheck-sunflower d-inline">
												<input type="radio" id="mantenimiento2" name="in_mante" value="0" checked />
									...
									<div class="form-group col-sm-12 col-md-3">
										...
										<div class="form-group clearfix">
											...
											<div class="icheck-sunflower d-inline">
												<input type="radio" id="inclMant2" name="in_ma_in" value="0" checked />
						...
						<div class="row">
							...
							<div class="form-group col-sm-6 col-md-3 mb-0">
								...
								<div class="form-group clearfix">
									<div class="icheck-sunflower d-inline pr-4">
										<input type="radio" id="publicidadyes" name="in_ad_pu" value="1" checked />
							...
							<div class="form-group col-sm-12 col-md-3">
								...
								<div class="form-group clearfix">
									<div class="icheck-sunflower d-inline pr-2">
										<input type="radio" id="compartida1" name="in_ad_co" value="1" />
										<label for="compartida1" class="form-label-options">SI </label>
									</div>
									<div class="icheck-sunflower d-inline">
										<input type="radio" id="compartida2" name="in_ad_co" value="0" />
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="icheck-sunflower form-group col-sm-4 col-md-3 col-lg-4">
								...
								<label for="closet_blancos" class="form-label-options">Closet de Blancos</label>
							</div>
							...
							<div class="icheck-sunflower form-group col-sm-4 col-md-3 col-lg-4">
								...
								<label for="walkCloset" class="form-label-options">Walkin Closet</label>
							</div>
						...
						<div class="row mt-4 mb-3">
							<div class="form-group input-custom-icon col-sm-12">
								...
								<textarea class="form-control" rows="3" placeholder="Otros Detalles" name="in_de_ot"></textarea>
								<label class="label-form-control" for="in_de_ot">Otros:</label>
							</div>
						</div>
						<hr>
						...
						<div class="row mt-3 mb-3">
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_ac_co" placeholder="Construcción" />
								<label class="label-form-control" for="in_ac_co">Construcción:</label>
							</div>
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_ac_pi" placeholder="Pisos" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_ac_pu" placeholder="Puertas" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_ac_te" placeholder="Techos" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-6">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<input type="text" class="form-control input-number-style" name="in_ac_ve" placeholder="Ventanas" />
							...
							<div class="form-group input-custom-icon col-sm-12 mt-3">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<textarea class="form-control" rows="3" placeholder="Otros Acabados" name="in_de_oa"></textarea>
						...
						<div class="row mt-4 mb-3">
							<div class="form-group input-custom-icon col-sm-12">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<textarea class="form-control" rows="3" placeholder="Otros" name="in_in_io"></textarea>
					...
					<fieldset>
						...
						<div class="row mt-4 mb-3">
							<div class="form-group input-custom-icon col-sm-12">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<textarea class="form-control" rows="3" placeholder="Otras Amenidades" name="in_am_ot"></textarea>
						...
						<div class="row">
							<div class="form-group col-sm-12 col-md-4">
								<div class="form-group border bg-dark rounded p-5" align="center">
									<i class="fas fa-photo-video" aria-hidden="true" style="font-size: 4rem;"></i>
								</div>
					...
					<fieldset>
						...
						<div class="row">
							...
							<!-- INSCRITO_SOCIEDAD -->
							<div class="form-group input-custom-icon col-sm-12 col-md-6 col-xl-6 order-xl-6 order-md-6">
								<label for="insSA" class="form-label-options d-block option-styles-title">Inscrita en una Sociedad
									Anónima:</label>
								<div class="icheck-sunflower d-inline pr-2">
									<input type="radio" id="insSA1" name="in_ab_s2" value="1" />
									<label for="insSA1" class="form-label-options">SI </label>
								</div>
								<div class="icheck-sunflower d-inline">
									<input type="radio" id="insSA2" name="in_ab_s2" value="0" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-7 order-md-7">
								...
								<div class="icheck-sunflower d-inline pr-2">
									<input type="radio" id="grabHIP1" name="in_ab_g1" value="1" />
									<label for="grabHIP1" class="form-label-options">SI </label>
								</div>
								<div class="icheck-sunflower d-inline">
									<input type="radio" id="grabHIP2" name="in_ab_g1" value="0" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-9 order-md-9 pt-3">
								...
								<select class="form-control" name="in_ab_ba">
									...
									<option value="2">Banco Inductrial</option>
									<option value="3">Banco Reformador</option>
									<option value="4">Banco CHN</option>
									<option value="5">Banco Promerica</option>
									<option value="6">Banco de Guatemala</option>
									<option value="7">Banco G&T Continental</option>
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-10 order-md-10">
								...
								<div class="icheck-sunflower d-inline pr-2">
									<input type="radio" id="avaREC1" name="in_ab_a1" value="1" />
									<label for="avaREC1" class="form-label-options">SI </label>
								</div>
								<div class="icheck-sunflower d-inline">
									<input type="radio" id="avaREC2" name="in_ab_a1" value="0" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-11 order-md-11 mb-0">
								...
								<div class="icheck-sunflower d-inline pr-2">
									<input type="radio" id="avaTYPE1" name="in_ab_at" value="1" />
									<label for="avaTYPE1" class="form-label-options">Comercial</label>
								</div>
								<div class="icheck-sunflower d-inline">
									<input type="radio" id="avaTYPE2" name="in_ab_at" value="2" />
							...
							<div class="form-group input-custom-icon col-sm-12 col-md-3 col-xl-3 order-xl-12 order-md-12">
								...
								<div class="form-group">
									<div class="icheck-sunflower d-inline pr-2">
										<input type="checkbox" id="timbres" name="in_ar_it" value="1">
										<label for="timbres" class="form-label-options">Timbres </label>
									</div>
									<div class="icheck-sunflower d-inline">
										<input type="checkbox" id="IVA" name="in_ar_ii" value="1">
						...
						<div class="row">
							<div class="form-group input-custom-icon col-sm-12">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<textarea class="form-control" rows="3" placeholder="Descripción de la Propiedad" name="in_ab_de"></textarea>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group input-custom-icon col-sm-12">
								<span class="fas fa-sticky-note form-control-feedback"></span>
								<textarea class="form-control" rows="3" placeholder="Notas Internas" name="in_ab_ni"></textarea>
							</div>
						</div>
	...
	<script>
		$(document).ready(function() {
			// initGeneral();
			$('#guardarPropiedad').submit(function () {
				$('#Guardando').fadeIn();
			})
