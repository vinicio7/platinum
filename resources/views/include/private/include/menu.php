...
<nav class="navbar navbar-light bg-white menu-horizontal" id="menuHorizontal">
	...
	<form class="form-inline ml-4 mr-auto d-none d-lg-block"><input _ngcontent-udd-c132="" type="search"
			placeholder="Buscar Propiedad" aria-label="Search" class="form-control form-control-solid mr-sm-2">
	</form>
